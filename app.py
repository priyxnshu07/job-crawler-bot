...
# Orphaned code removed
                    ...
                    for location in locations[:3]:
                        for query in queries[:3]:
                            try:
                                ...
                                print(f"Unexpected error scraping {query} in {location}: {str(e)[:50]}")
                                continue
            ...
            print(f"✅ Manual scrape complete. Added {new_jobs_count} new jobs.")
        except Exception as e:
    ...
    return jsonify({
        "message": "Scraping started! It will run in the background. Check logs for progress.",
        "status": "started"
    })
